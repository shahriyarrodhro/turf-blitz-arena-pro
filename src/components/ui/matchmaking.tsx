...
import { Search, MapPin, Clock, Users, Star, Trophy, Target, Filter, X } from 'lucide-react';
  ...
  if (isOpen !== undefined) {
    ...
    return (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
        <Card className="w-full max-w-6xl h-[80vh] bg-white/95 backdrop-blur-md border-gray-200/50 mx-4">
          <CardHeader className="flex flex-row items-center justify-between p-4 border-b border-gray-200/50">
            <div className="flex items-center space-x-3">
              <Target className="w-6 h-6 text-emerald-600" />
              <h3 className="text-xl font-semibold text-gray-800">Find Your Match</h3>
            </div>
