...
import { Calendar, MapPin, Trophy, Users, Star, Play, ArrowRight, Shield, Zap, Target, Search, Filter, ChevronRight, Clock, Heart } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 relative overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="relative z-50 backdrop-blur-2xl bg-white/10 border-b border-white/20 sticky top-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            >
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-emerald-600 bg-clip-text text-transparent">TurfX</span>
            </motion.div>
            ...
            <div className="flex items-center space-x-3">
              <Button 
                ...
                className="text-gray-700 hover:text-emerald-600 hidden sm:flex backdrop-blur-sm"
              >
                Login
              </Button>
              <Button 
      ...
      <section className="relative pt-16 pb-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            {/* Advanced Search with Glassmorphism */}
            <Card className="backdrop-blur-2xl bg-white/20 border border-white/30 rounded-3xl shadow-2xl p-8 mb-12 mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 h-14 rounded-2xl border-white/30 bg-white/40 backdrop-blur-md text-lg placeholder:text-gray-500 shadow-lg"
                    />
                  </div>
                  
                  <Select value={selectedLocation} onValueChange={setSelectedLocation}>
                    <SelectTrigger className="h-14 rounded-2xl border-white/30 bg-white/40 backdrop-blur-md shadow-lg">
                  ...
                  <Button 
                    onClick={() => navigate('/turfs')}
                    className="h-14 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white rounded-2xl font-semibold text-lg shadow-xl transition-all duration-300 hover:scale-105"
                  >
