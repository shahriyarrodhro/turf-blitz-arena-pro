    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <Avatar className="w-10 h-10">
                  ...
                  <AvatarFallback className="bg-gradient-to-r from-blue-500 to-purple-600 text-white">AR</AvatarFallback>
                </Avatar>
                <div className="hidden md:block">
                  <div className="text-gray-800 font-medium">Ahmed Rahman</div>
                  <div className="text-gray-500 text-sm">Player</div>
                </div>
              </div>
              <Button 
                variant="ghost"
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Welcome back, Ahmed! ⚽</h1>
          <p className="text-gray-600">Ready for your next match? Let's see what's coming up.</p>
        </motion.div>
